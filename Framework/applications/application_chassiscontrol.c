...
PID_Regulator_t CMFLSpeedPID = PID_INIT(1.0, 0.0, 0.0, 35000.0, 10000.0, 10000.0, 32000.0);
PID_Regulator_t CMFRSpeedPID = PID_INIT(1.0, 0.0, 0.0, 35000.0, 10000.0, 10000.0, 32000.0);
PID_Regulator_t CMBLSpeedPID = PID_INIT(1.0, 0.0, 0.0, 35000.0, 10000.0, 10000.0, 32000.0);
PID_Regulator_t CMBRSpeedPID = PID_INIT(1.0, 0.0, 0.0, 35000.0, 10000.0, 10000.0, 32000.0);
